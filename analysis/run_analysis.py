import os
from analysis.analysis_suite.analyser import Analyser, get_even_weighted_train_test_split
...
def run_initial_data_analysis():
    ...
    x_train, x_test, y_train, y_test = get_even_weighted_train_test_split(analyser)
    ...
    GraphBuilder() \
        ...
        .with_heat_map(confusion_matrix, 'logistic_regression_attempt_2_heat_map.png', annotate=True, fig_size=(5, 5))
